...
app.post("/jokes", (req,res) => {
  const newJoke = { id: jokes.length , jokeText: req.body.text , jokeType: req.body.type};
  jokes.push(newJoke);
...
app.put("/jokes/:id" , (req,res) => {
  const id = parseInt(req.params.id);
  const replacementJoke = { id: id, jokeText: req.body.text , jokeType: req.body.type};
...
app.patch("/jokes/:id", (req,res) =>{ 
  ...
  const replacementJoke = {id: id, jokeText: req.body.text || existingJoke.jokeText , jokeType: req.body.type || existingJoke.jokeType};
  const searchIndex = jokes.findIndex((joke) => joke.id === id);
  jokes[searchIndex] = replacementJoke;
